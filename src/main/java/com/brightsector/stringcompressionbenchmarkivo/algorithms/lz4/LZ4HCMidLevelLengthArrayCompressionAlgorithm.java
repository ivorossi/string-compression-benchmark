...
public class LZ4HCMidLevelLengthArrayCompressionAlgorithm extends LZ4LengthArrayCompressionAlgorithm {

	@Override
	protected LZ4Compressor setLevel() {
		return LZ4Factory.fastestInstance().highCompressor(Util.LZ4_MID_LEVEL);
	}
