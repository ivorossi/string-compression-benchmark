...
public class LZ4HCHighLevelLengthArrayCompressionAlgorithm extends LZ4LengthArrayCompressionAlgorithm {

	@Override
	protected LZ4Compressor setLevel() {
		return LZ4Factory.fastestInstance().highCompressor(Util.LZ4_HIGH_LEVEL);
	}
